...
class time_heap
{
    public:
        ...
        {
            array = new heap_timer* [capacity];         // 创建堆数据
            if (!array) {
                throw std::exception();
            }
    ...
    public:
        ...
        void del_timer(heap_timer* timer)
        {
             ...
             * 这将节省真正删除该定时器造成的开销，但这样做容易是堆数组膨胀
             */
            timer->cb_func = NULL;
        }
    ...
    private:
        // 最小堆的下虑操作，它确保堆数组中以第hole个结点作为根的子树拥有的最小堆性质
